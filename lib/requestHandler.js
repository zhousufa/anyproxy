  ...
  return function (req, userRes) {
    ...
    */
    ...
    co(fetchReqData)
      ...
      .then(
        co.wrap(function *() {
          const xForward = requestDetail._req.socket.remoteAddress
            .split(':')
            .pop();
          ...
          finalReqDetail.requestOptions.headers['X-Forwarded-For'] = xForward;
  ...
  return function (req, cltSocket, head) {
    ...
    */
    co(function *() {
      ...
      const xForward = requestDetail._req.socket.remoteAddress.split(':').pop();

      requestDetail._req.headers['X-Forwarded-For'] = xForward;
